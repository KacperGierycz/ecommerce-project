...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.checkoutFormGroup=this.formBuilder.group({
      customer:this.formBuilder.group({
        ...
        lastName: new FormControl(theEmail,[Validators.required,Validators.minLength(2),Luv2ShopValidators.notOnlyWhitespaces]),
    ...
    // populated credit cards years
      ...
      this.luv2shopFormService.getCreditCardYears().subscribe(
        ...
        this.luv2shopFormService.getCoutries().subscribe(
          data=>{
  ...
  onSubmit(){
    ...
    */
    ...
    this.CheckoutService.placeOrder(purchase).subscribe({
        next: response =>{
          alert(`Your orderder has been recived.\nOrder tracking number:
  ...
  handleMonthAndYears(){
    ...
    // if the current year equals the selected year, then start with the current manth
